...
<head>
    ...
    <style>
        ...
        .jumbotron-bg {
            background-image: url('https://komuniku.ac.id/wp-content/uploads/2023/01/Header-Home.jpg');
    ...
    <div class="container-fluid my-4">
        <div class="row">
            ...
            <main class="col-md-10">
                <article>
                    <?php
                    extract($_GET); // Mengambil parameter dari URL

                    if (isset($menu)) {
                        if ($menu == "a") {
                            include "Latihan_08_a.php";
                        } elseif ($menu == "b") { // Menambahkan pengecekan untuk menu b
                            include "Latihan_08_b.php";
                        } elseif ($menu == "c") { // Menambahkan pengecekan untuk menu c
